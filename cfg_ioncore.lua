...
defbindings("WScreen", {
    ...
    kpress("Mod4+comma", "WScreen.switch_prev(_)"),
    kpress("Mod4+period", "WScreen.switch_next(_)"),
...
--     kpress("Mod4+comma", "ioncore.goto_prev_screen()"),
--     kpress("Mod4+period", "ioncore.goto_next_screen()"),
    
    bdoc("Create a new workspace of chosen default type."),
    kpress("Mod4+F9", "ioncore.create_ws(_)"),
    
    bdoc("Display the main menu."),
    kpress("Mod4+F12", "mod_query.query_menu(_, _sub, 'mainmenu', 'Main menu:')"),
...
defbindings("WClientWin", {
    ...
    kpress_wait("Mod4+L", "WClientWin.nudge(_)"),
...
defbindings("WMPlex", {
    ...
    kpress_wait("Mod4+Mod1+C", "WRegion.rqclose_propagate(_, _sub)"),
})

-- Frames for transient windows ignore this bindmap
defbindings("WMPlex.toplevel", {
    bdoc("Toggle tag of current object."),
    kpress("Mod4+T", "WRegion.set_tagged(_sub, 'toggle')", "_sub:non-nil"),

    bdoc("Query for command line to execute."),
    kpress("Mod4+S", "mod_query.query_exec(_)"),

    bdoc("Query for Lua code to execute."),
    kpress("Mod4+F3", "mod_query.query_lua(_)"),

    bdoc("Query for workspace to go to or create a new one."),
    kpress("Mod4+F9", "mod_query.query_workspace(_)"),
    
    bdoc("Query for a client window to go to."),
    kpress("Mod4+G", "mod_query.query_gotoclient(_)"),
