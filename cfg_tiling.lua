...
defbindings("WTiling", {
    ...
    kpress("Mod4+S", "WTiling.split_at(_, _sub, 'bottom', true)"),
    
    bdoc("Go to frame above/below/right/left of current frame."),
    kpress("Mod4+P", "ioncore.goto_next(_sub, 'up', {no_ascend=_})"),
    kpress("Mod4+N", "ioncore.goto_next(_sub, 'down', {no_ascend=_})"),
    kpress("Mod4+Tab", "ioncore.goto_next(_sub, 'right')"),
    submap(META.."K", {
